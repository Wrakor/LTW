...
<div style="min-width: 1000px;">
	<form action="showCustomerSearch.php" method="GET">
		...
		<br><br>
		Campo:<br>
		<input type="radio" name="field" value="CustomerID"><label for="CustomerID">ID do Cliente</label>
	    <input type="radio" name="field" value="CustomerTaxID"><label for="CustomerTaxID">ID da Taxa do Cliente</label>
