...
<HTML>
	...
	<BODY>
	<div id="conteudo">
		<form action="return3.php" method="GET">
			OP:
			...
			<br>
			Field:
			<input type="radio" name="field" value="ProductCode"><label for="ProductCode">Código do Produto</label>
		    <input type="radio" name="field" value="ProductDescription"><label for="ProductDescription">Descrição do Produto</label>		    
		   <br>
			Value: <br><input type="text" name="value1" value="">
