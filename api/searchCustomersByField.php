...
<HTML>
	...
	<div id="conteudo">
		<form action="return2.php" method="GET">
			...
			<br>
			Field:
			<input type="radio" name="field" value="CustomerID"><label for="CustomerID">Identificação do Cliente</label>
		    <input type="radio" name="field" value="CustomerTaxID"><label for="CustomerTaxID">Identificação da Taxa do Cliente</label>
